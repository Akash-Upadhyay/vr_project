...
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), 'output', 'unet')
...
def create_dataset():
    ...
    for face_path in face_crops:
        ...
        if segmentation_paths:
            valid_samples.append((face_path, segmentation_paths[0]))
...
def build_unet_model():
    ...
    # Encoder (Contracting Path) - Simplified for demonstration
    ...
    # Decoder (Expansive Path) - Simplified for demonstration
...
def train_unet_model():
    ...
    model_path = os.path.join(MODEL_DIR, f'unet_model_{timestamp}.h5')
...
if __name__ == "__main__":
    ...
    # Check if CUDA is available and set memory growth
